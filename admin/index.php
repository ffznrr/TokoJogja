...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0; Background: #0099FF0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html" style="background: #0099FF0">TOKO MUTIARA</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li><a class="active-men"  href="index.php" ><i class="fa fa-dashboard "></i> Beranda</a></li>
                    <li><a class="active-men"  href="index.php?halaman=kategori"><i class="fa fa-cube"></i> Kategori</a></li>
                    <li><a class="active-men"  href="index.php?halaman=produk"><i class="fa fa-tags"></i> Produk</a></li>
                    <li><a class="active-men"  href="index.php?halaman=pembelian"><i class="fa fa-shopping-cart"></i> Pembelian</a></li>
                    <li><a class="active-men"  href="index.php?halaman=pelanggan"><i class="fa fa-user"></i> Data Usr</a></li>
                    <li><a class="active-men"  href="index.php?halaman=laporan"><i class="fa fa-file"></i> Laporan</a></li>
                    <li><a class="active-men"  href="index.php?halaman=profil"><i class="fa fa-cogs"></i> Pengaturan</a></li>
                    <li><a class="active-men"  href="index.php?halaman=logout"><i class="fa fa-sign-out"></i> Keluar</a></li>
                </ul>
